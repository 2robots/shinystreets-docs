...
\begin{table}[htb]
	...
	\begin{tabular}{|l|c|c|}
		...
		\hline
	\end{tabular}
	\caption{Seminar for Bachelor Students}
...
%
Alternatively, you may include figures prepared in external tools (cf. Figure~\ref{fig:samplefigure_pdf}). Note, to ensure high quality printing, all figures must have at least 300 \ac{dpi}.
